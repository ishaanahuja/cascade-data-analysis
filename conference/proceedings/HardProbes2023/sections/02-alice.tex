...
along with their charge conjugate. The reconstructed decay particles are filtered through a set of kinematic and geometric selection criteria to ensure 
...
are subsequently identified through invariant-mass analyses. For short-lived resonance $\phi \rightarrow \textnormal{K}^{+}\, \textnormal{K}^{-}$ where 
topological selections are not required, signal extraction can be performed based on invariant-mass analysis. 
