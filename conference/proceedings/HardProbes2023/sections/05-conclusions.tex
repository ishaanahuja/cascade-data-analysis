...
Utilising the method of two particle correlations, it can be observed that strange hadrons in jets have different production mechanism than 
...
ratios demonstrate this multiplicity dependent enhancement, which is compatible for in-jet and out-of-jet regions. However, all observed cases point to 
