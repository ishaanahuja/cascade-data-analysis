...
jet axis and defines the near-side jet region. Alternatively, soft processes involving particle production governed by bulk properties of the medium, 
characterised by low momentum transfer, lie in the transverse to leading or out-of-jet regions. Understanding the relative contribution of hard and soft 
...
($\Delta\varphi,\:\Delta\eta$) plane involves identifying strange hadrons produced in the vicinity of the jet-leading or trigger particle. The analyses 
presented here impose kinematic selection criteria for the trigger particles: \pt$ > 3\:\mathrm{GeV}/c$ ($\ks,\:\Xi^{\pm}$) and 
$4 < $ \pt $< 8\:\mathrm{GeV}/c$ ($\phi,\:\Lambda$). From the same event, strange hadrons of interest identified in close angular proximity to the trigger particle are labeled as 
"associated" particles. The angular correlations can be constructed using the angular differences ($\Delta\varphi,\:\Delta\eta$) between the trigger 
