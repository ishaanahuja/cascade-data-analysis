...
The \pt\, integrated yields for $\ks$ and $\Xi$ can be obtained by summing the bin contents and extrapolating the \pt\, spectra in low and high \pt\, regions, 
where the yield cannot be measured, using an average integral of four fit functions --- Levi-Tsallis, Boltzmann, Fermi-Dirac and 
$m_T$ scaling.
