...
// #include "CascadeUtils.h" // Contains constants, enums, paths, basic utils
// #include "ExtraUtils.C"   // Contains all fit function definitions
    ...
    Int_t verbosity = kInfo)
{
    ...
    Info("RunYieldMean", "You can now run the PlottingUtils.C macro to generate the final plots.");
