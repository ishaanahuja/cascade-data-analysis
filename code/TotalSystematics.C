/**
 * @file TotalSystematics.C
 * @author Ishaan Ahuja (ishaanahuja0@gmail.com)
 * @brief Calculates total systematic uncertainties by combining various sources for Xi and Omega particles (multi-trial, signal extraction, mat. budget)
 * @version 1
 * @date 12-06-2025
 *
 ...
 *
 * @note Replaced by LevyTsallisFit() above.
 */
