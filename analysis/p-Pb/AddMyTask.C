AliCascadeAnalysis_Ishaan *AddMyTask(bool K0s = false, bool Lam = false, bool Xi = true, bool Om = true, TString suffix = "")
{
  // analysis manager
  ...
  AliCascadeAnalysis_Ishaan *mytask = new AliCascadeAnalysis_Ishaan(tskname);
  mgr->AddTask(mytask);
