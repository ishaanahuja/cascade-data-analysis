...
int AliCascadeAnalysisMC_Ishaan_Draw(std::string input = "AliCascadeAnalysisMC_Ishaan_Fitting.root", TString outputFilename = "AliCascadeAnalysisMC_Ishaan_Draw.root", TString outputFolder = ".", Bool_t saveImages = kFALSE, Bool_t saveStack = kTRUE)
{
    ...
    {
        output = input;
        output.ReplaceAll("AliCascadeAnalysisMC_Ishaan_Fitting.root", "AliCascadeAnalysisMC_Ishaan_Draw.root");
    }
