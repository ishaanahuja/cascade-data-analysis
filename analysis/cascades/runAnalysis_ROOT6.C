...
void runAnalysis_ROOT6()
{
    ...
    gInterpreter->LoadMacro("CascadeTask.cxx++g");

    CascadeTask *task = reinterpret_cast<CascadeTask *>(gInterpreter->ExecuteMacro("AddMyTask.C"));
    ...
    else
    {
        ...
        alienHandler->SetAdditionalLibs("CascadeTask.h CascadeTask.cxx");
        alienHandler->SetAnalysisSource("CascadeTask.cxx");
        ...
        alienHandler->SetGridWorkingDir("cascWorkDir");
        alienHandler->SetGridOutputDir("cascOutDir");
