#ifndef AliCascadeAnalysis_Ishaan_H
#define AliCascadeAnalysis_Ishaan_H
...
class AliCascadeAnalysis_Ishaan : public AliAnalysisTaskSE
{
public:
    AliCascadeAnalysis_Ishaan();
    AliCascadeAnalysis_Ishaan(const char *name, TString lExtraOptions = "");
    virtual ~AliCascadeAnalysis_Ishaan();
...
private:
    ...
    AliCascadeAnalysis_Ishaan(const AliCascadeAnalysis_Ishaan &);            // not implemented
    AliCascadeAnalysis_Ishaan &operator=(const AliCascadeAnalysis_Ishaan &); // not implemented

    ClassDef(AliCascadeAnalysis_Ishaan, 6);
