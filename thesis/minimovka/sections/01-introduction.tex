...
current results showing the raw $p_\textnormal{{T}}$ spectra are presented.
...
coupling constant is calibrated at mass of $Z^{0}$ boson ($\Lambda_{QCD} \approx 200$ MeV). From the experimental results (Fig. \ref{fig:CouplingQCD}), 
...
has been hypothesised early on and presumed to exist in neutron stars and the early universe, shortly after the Planck epoch according to the Big Bang 
theory. 
...
quark-gluon plasma. For a critical point $E$ on the diagram, lattice QCD approach determines $T_{E}\approx160$ MeV and $\mu_{E}\approx725$ MeV\cite{Fodor:2002}. 
At minimal $\mu_{B}$ values, 
...
According to recent lattice calculations, a slightly lower transition temperature ($T_{c}\approx155$ MeV) is forecasted\cite{Bazavov:2012, Bhattacharya:2014}, 
...
such as $\Xi^{\pm}$ and $\Omega^{\pm}$ in p-Pb collisions at LHC energies $\sqrt{s_{NN}}$ = 8.16 TeV in the ALICE detector are presented. An overview 
...
the analysis and raw $p_{\textnormal{T}}$ spectra results, the final goals and outlook is presented.
