...
has been hypothesized early on and presumed to exist in neutron stars and the early universe, shortly after the Plank epoch according to the Big Bang 
theory. 
...
The grand canonical ensemble characterizes nuclear matter in thermodynamic equilibrium with respect to temperature $T$, volume $V$, and the 
baryo-chemical potential $\mu_{B}$. Here, $\mu_{B}$ is the chemical potential of the conserved baryon number. Figure \ref{fig:QcdPhaseDiagram} 
...
\begin{enumerate}
  ...
  \item Increased yield of strange and multi-strange mesons and baryons
  \item Jet Quenching
...
such as $\Xi^{\pm}$ and $\Omega^{\pm}$ in p-Pb collisions at LHC energies $\sqrt{s_{NN}}$ = 8.16TeV in the ALICE detector are presented. An overview 
...
the analysis and raw $p_{T}$ spectra results, the final goals and outlook is presented.
