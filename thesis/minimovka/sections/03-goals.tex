...
\begin{itemize}
      ...
      \item Raw (uncorrected) transverse momentum spectra extraction for cascade particles in p-Pb collisions at $\sqrt{s_{\textnormal{\sc nn}}}$ =
            8.16 
            TeV distributed over different multiplicity classes.
      ...
      \item Analysis of the mean transverse momenta, integrated yields, and adjusted $p_{\textnormal{T}}$ spectra for systematic errors and uncertainties.
\end{itemize}